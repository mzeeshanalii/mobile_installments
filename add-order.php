...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($con, "INSERT INTO `orders` (`customer_id`, `order_date`,`total_amount`, `payment_status`) VALUES ('$customer_id', '$date', '$amount', '$status')");
    $order_id = mysqli_insert_id($con);
    $sql= mysqli_query($con, "INSERT INTO `installment_plans` (`order_id`,`total_installments`,`installment_amount`,`start_date`)VALUE('$order_id','$total_install','$installments','$date')");
    $sql=mysqli_query($con, "INSERT INTO `order_items` (`order_id`,`product_id`,`quantity`,`subtotal`)VALUES('$order_id','$product_id','$quantity','$subtotal')");
    if($sql){
